...
In WSO2 API Manager 1.4.0 product distribution, `carbon.xml` configuration file <br>
...
> In here, <TARGET_CONFIGS> refers to /home/wso2carbon/wso2is-am-1.4.0/repository/conf folder of the container.
