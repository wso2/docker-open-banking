...
DROP DATABASE IF EXISTS openbank_geolocationdb  ; CREATE DATABASE openbank_geolocationdb;
DROP DATABASE IF EXISTS openbank_ob_reporting_statsdb  ; CREATE DATABASE openbank_ob_reporting_statsdb;
DROP DATABASE IF EXISTS openbank_ob_reporting_summarizeddb  ; CREATE DATABASE openbank_ob_reporting_summarizeddb;
