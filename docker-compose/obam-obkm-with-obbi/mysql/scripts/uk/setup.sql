...
CREATE TABLE IF NOT EXISTS OB_CONSENT_METADATA (
 ...
 CREATE TABLE IF NOT EXISTS UK_NOTIFICATION_SUBSCRIPTION (
 ...
 CREATE TABLE IF NOT EXISTS UK_NOTIFICATION_SUBS_EVENTS (
    SUBSCRIPTION_ID int(10) NOT NULL,
    EVENT_TYPE varchar(100) NOT NULL,
    PRIMARY KEY(SUBSCRIPTION_ID, EVENT_TYPE),
    FOREIGN KEY (SUBSCRIPTION_ID) REFERENCES UK_NOTIFICATION_SUBSCRIPTION(SUBSCRIPTION_ID)
 ) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS UK_NOTIFICATION_EVENT (
    ID int(11) NOT NULL AUTO_INCREMENT,
    NOTIFICATION_ID varchar(36) NOT NULL,
    EVENT_TYPE varchar(200) NOT NULL,
    EVENT varchar(1000) NULL DEFAULT NULL,
    PRIMARY KEY (ID),
    CONSTRAINT FK_NotificationEvent FOREIGN KEY (NOTIFICATION_ID) REFERENCES UK_NOTIFICATION(NOTIFICATION_ID)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS UK_NOTIFICATION_ERROR (
    NOTIFICATION_ID varchar(36) NOT NULL,
    ERROR_CODE varchar(10) NOT NULL,
    DESCRIPTION varchar(100) NOT NULL,
    PRIMARY KEY (NOTIFICATION_ID),
    CONSTRAINT FK_NotificationError FOREIGN KEY (NOTIFICATION_ID) REFERENCES UK_NOTIFICATION(NOTIFICATION_ID)
) ENGINE=InnoDB;
