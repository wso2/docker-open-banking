...
CREATE DATABASE openbank_apimgtdb CHARACTER SET latin1 COLLATE latin1_swedish_ci;

DROP DATABASE IF EXISTS openbank_am_configdb;
CREATE DATABASE openbank_am_configdb CHARACTER SET latin1 COLLATE latin1_swedish_ci;

DROP DATABASE IF EXISTS openbank_govdb;
CREATE DATABASE openbank_govdb CHARACTER SET latin1 COLLATE latin1_swedish_ci;

DROP DATABASE IF EXISTS openbank_userdb;
CREATE DATABASE openbank_userdb CHARACTER SET latin1 COLLATE latin1_swedish_ci;

DROP DATABASE IF EXISTS openbank_iskm_configdb;
CREATE DATABASE openbank_iskm_configdb CHARACTER SET latin1 COLLATE latin1_swedish_ci;

DROP DATABASE IF EXISTS openbank_openbankingdb;
CREATE DATABASE openbank_openbankingdb CHARACTER SET latin1 COLLATE latin1_swedish_ci;
