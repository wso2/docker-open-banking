DROP DATABASE IF EXISTS openbank_am_configdb;
CREATE DATABASE openbank_am_configdb;

DROP DATABASE IF EXISTS openbank_apimgt_statsdb;
CREATE DATABASE openbank_apimgt_statsdb;

DROP DATABASE IF EXISTS openbank_apimgtdb;
CREATE DATABASE openbank_apimgtdb;

DROP DATABASE IF EXISTS openbank_openbankingdb;
CREATE DATABASE openbank_openbankingdb;

DROP DATABASE IF EXISTS openbank_govdb;
CREATE DATABASE openbank_govdb;

DROP DATABASE IF EXISTS openbank_iskm_configdb;
CREATE DATABASE openbank_iskm_configdb;

DROP DATABASE IF EXISTS openbank_userdb;
CREATE DATABASE openbank_userdb;

DROP DATABASE IF EXISTS openbank_geolocationdb;
CREATE DATABASE openbank_geolocationdb;

DROP DATABASE IF EXISTS openbank_ob_reporting_statsdb;
CREATE DATABASE openbank_ob_reporting_statsdb;

DROP DATABASE IF EXISTS openbank_ob_reporting_summarizeddb;
CREATE DATABASE openbank_ob_reporting_summarizeddb;

/*
Create tables for openbank_geolocationdb
*/

USE openbank_geolocationdb;
...
/*
Create tables for openbank_openbankingdb
*/

USE openbank_openbankingdb;

CREATE TABLE IF NOT EXISTS BG_PAYMENT_CONSENT (
    PAYMENT_ID                   VARCHAR(255)   NOT NULL,
    REQUEST_BODY                 VARCHAR(60000) NOT NULL,
    PAYMENT_TYPE                 VARCHAR(255) NOT NULL,
    PAYMENT_PRODUCT              VARCHAR(255) NOT NULL,
    REQUEST_INITIATION_TIMESTAMP TIMESTAMP      NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE BG_ACCOUNT_BINDING (
    CONSENT_ID VARCHAR(255)  NOT NULL,
    ACCOUNT_CONSENT VARCHAR(60000) NOT NULL,
...
-- Berlin Confirmation of Funds Related Tables
CREATE TABLE BG_COF_INITIALIZATION (
    CONSENT_ID VARCHAR(255)  NOT NULL,
    X_REQUEST_ID VARCHAR(255) NOT NULL,
    PSU_ID VARCHAR(255),
    PSU_ID_TYPE VARCHAR(64),
...
CREATE TABLE BG_COF_BINDING (
    CONSENT_ID VARCHAR(255)  NOT NULL,
    COF_CONSENT_DATA VARCHAR(60000) NOT NULL,
    PRIMARY KEY (CONSENT_ID),
    CONSTRAINT FK_CONSENT_ID_BG_COF_BINDING FOREIGN KEY (CONSENT_ID) REFERENCES BG_COF_INITIALIZATION (CONSENT_ID) ON DELETE CASCADE
)ENGINE INNODB;

CREATE TABLE BG_COF_CONSENT_STATUS (
    OLD_STATUS VARCHAR(64) NOT NULL,
    NEW_STATUS VARCHAR(64) NOT NULL,
    ACTION_BY VARCHAR(64) NOT NULL,
    CONSENT_ID VARCHAR(255)  NOT NULL,
    REASON VARCHAR(1023)  NOT NULL,
    ACTION_DATETIME DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT FK_CONSENT_ID_BG_COF_CONSENT_STATUS FOREIGN KEY (CONSENT_ID) REFERENCES BG_COF_INITIALIZATION (CONSENT_ID) ON DELETE CASCADE
)ENGINE INNODB;


/*
Create tables for openbank_govdb
*/
...
ALTER TABLE REG_RESOURCE_PROPERTY
...
/*
Create tables for openbank_iskm_configdb
*/

USE openbank_iskm_configdb;
...
/*
Create tables for openbank_userdb
*/
...
/*
Create tables for openbank_am_configdb
*/

USE openbank_am_configdb;
